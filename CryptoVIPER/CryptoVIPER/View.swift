...
class CryptoViewController : UIViewController, AnyView, UITableViewDelegate, UITableViewDataSource {
    ...
    private let messsageLabel : UILabel = {
        let label = UILabel()
        label.isHidden = false
    ...
    override func viewDidLayoutSubviews() {
        ...
        messsageLabel.frame = CGRect(x: view.frame.width / 2 - 100, y: view.frame.height / 2 - 25, width: 200, height: 50)
    }
    ...
    func update(with cryptos: [Crypto]) {
        DispatchQueue.main.async {
            ...
            self.messsageLabel.isHidden = true
    ...
    func update(with error: String) {
        DispatchQueue.main.async {
            ...
            self.messsageLabel.text = error
            self.messsageLabel.isHidden = false
        }
    }
